...
\end{center}
\vspace{-0.07in}
Table 2 counts validation checks or receipt records; failures are accepted violations or false rejects. The audits reject key/closure drift, replay, lane mismatch, transition edits, and unsafe transforms; batch receipts keep overhead at 1.20$\times$ on CartPole and 1.30--1.64$\times$ on Brax/JAX.
